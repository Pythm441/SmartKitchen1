...
struct LunchView: View {
    @State private var api: API1_Lunch?
    ...
    private func performAPISearch(query: String) {
        ...
        Task {
            do {
                ...
                self.api = try JSONDecoder().decode(API1_Lunch.self, from: data)
...
struct API1_Lunch: Codable {
    var results: [API2_Lunch]
    var offset: Int
    var number: Int
    var totalResults: Int
}

struct API2_Lunch: Hashable, Codable {
    var id: Int
    var title: String
    var image: URL
