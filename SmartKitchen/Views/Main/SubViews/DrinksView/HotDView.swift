...
struct HotDView: View {
    @State private var api: API1_HotD?
    ...
    private func performAPISearch(query: String) {
        ...
        Task {
            do {
                ...
                self.api = try JSONDecoder().decode(API1_HotD.self, from: data)
...
struct API1_HotD: Codable {
    var results: [API2_HotD]
    var offset: Int
    var number: Int
    var totalResults: Int
}

struct API2_HotD: Hashable, Codable {
    var id: Int
    var title: String
    var image: URL
